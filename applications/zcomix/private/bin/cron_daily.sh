...
regex="/srv/http/(.*)/web2py/applications/zcomix/*"
[[ $bin =~ $regex ]]
...
py=$web2py_root/applications/zcomix/private/bin/python_web2py.sh

# Tally book ratings
__v && __md "Start: tally_book_ratings.py"
$py applications/zcomix/private/bin/tally_book_ratings.py
