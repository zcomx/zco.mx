...
TEMPLATES = [
    {
        ...
        'template_web': """TO THE EXTENT POSSIBLE UNDER LAW, {owner} HAS <a href="{url}">WAIVED ALL COPYRIGHT AND RELATED OR NEIGHBORING RIGHTS</a> TO <i>{title}</i>.  THIS WORK IS PUBLISHED FROM: {place}."""
    },
    {
        'number': 1,
        'code': 'CC BY',
        ...
        'template_web': """ <i>{title}</i> IS COPYRIGHT (C) {year} BY {owner}.  THIS WORK IS LICENSED UNDER THE <a href="{url}">CC BY 4.0 INT`L LICENSE</a>."""
    },
    {
        'number': 2,
        'code': 'CC BY-ND',
        ...
        'template_web': """ <i>{title}</i> IS COPYRIGHT (C) {year} BY {owner}.  THIS WORK IS LICENSED UNDER THE <a href="{url}">CC BY-ND 4.0 INT`L LICENSE</a>."""
    },
    {
        'number': 3,
        'code': 'CC BY-SA',
        ...
        'template_web': """ <i>{title}</i> IS COPYRIGHT (C) {year} BY {owner}.  THIS WORK IS LICENSED UNDER THE <a href="{url}">CC BY-SA 4.0 INT`L LICENSE</a>."""
    },
    {
        'number': 4,
        'code': 'CC BY-NC',
        ...
        'template_web': """ <i>{title}</i> IS COPYRIGHT (C) {year} BY {owner}.  THIS WORK IS LICENSED UNDER THE <a href="{url}">CC BY-NC 4.0 INT`L LICENSE</a>."""
    },
    {
        'number': 5,
        'code': 'CC BY-NC-ND',
        ...
        'template_web': """ <i>{title}</i> IS COPYRIGHT (C) {year} BY {owner}.  THIS WORK IS LICENSED UNDER THE <a href="{url}">CC BY-NC-ND 4.0 INT`L LICENSE</a>."""
    },
    {
        'number': 6,
        'code': 'CC BY-NC-SA',
        ...
        'template_web': """ <i>{title}</i> IS COPYRIGHT (C) {year} BY {owner}.  THIS WORK IS LICENSED UNDER THE <a href="{url}">CC BY-NC-SA 4.0 INT`L LICENSE</a>."""
    },
    {
        'number': 7,
