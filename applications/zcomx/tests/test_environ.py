...
Test suite for zcomx/modules/environ.py
"""
import os
import unittest
from gluon.globals import Request
from applications.zcomx.modules.environ import (
...
class TestFunctions(LocalTestCase):
    ...
    def tearDownClass(cls):
        for k, v in list(cls._env.items()):
            os.environ[k] = v
    ...
    def test__server_production_mode(self):
        ...
        self.assertRaises(
            ServerEnvironmentError, server_production_mode, request)
